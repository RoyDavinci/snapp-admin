        ...
        <div className="ur-inner flex gap-x-10 justify-between items-center">
            ...
            <div className="ur-inner-left w-6/6">
                <div className="ur-top flex w-full justify-between items-center mb-3">
                    <h3 className='text-lg text-black font-semibold'>Reports By Category</h3>
                    <BsThreeDotsVertical/>
                </div>
                ...
                <div className='ur-bottm flex gap-x-10 justify-between'>
                    <ul className=" text-md font-medium w-[40%]  space-y-2">
                        <li className='flex justify-between items-center w-full'>
                            <h3 className='text-[#11142D] flex items-center'><BsDot size={35} color={'#4879F5'}/>Crashs</h3>
                            <span className='text-[#808191]'>{crashCount}</span>
                        </li>
                        <li className='flex justify-between items-center w-full'>
                            <h3 className='text-[#11142D] flex items-center'><BsDot size={35} color={'#44D2F'}/>Hazards</h3>
                            <span className='text-[#808191]'>{hazardCount}</span>
                        </li>
                        <li className='flex justify-between items-center w-full'>
                            <h3 className='text-[#11142D] flex items-center'><BsDot size={35} color={'#20C745'}/>Traffic</h3>
                            <span className='text-[#808191]'>{trafficCount}</span>
                        </li>
                        <li className='flex justify-between items-center w-full'>
                            <h3 className='text-[#11142D] flex items-center'><BsDot size={35} color={'#F4A74B'}/>Fire Outbreaks</h3>
                            <span className='text-[#808191]'>{fireCount}</span>
                        </li>
                        <li className='flex justify-between items-center w-full'>
                            <h3 className='text-[#11142D] flex items-center'><BsDot size={35} color={'#482cae'}/>Riots</h3>
                            <span className='text-[#808191]'>{riotCount}</span>
                        </li>
                        <li className='flex justify-between items-center w-full'>
                            <h3 className='text-[#11142D] flex items-center'><BsDot size={35} color={'#F45252'}/>Floods</h3>
                            <span className='text-[#808191]'>{floodCount}</span>
                        </li>
                        <li className='flex justify-between items-center w-full'>
                            <h3 className='text-[#11142D] flex items-center'><BsDot size={35} color={'#012b12'}/>Law Enforcement</h3>
                            <span className='text-[#808191]'>{lawEnforcementCount}</span>
                        </li>
                        <li className='flex justify-between items-center w-full'>
                            <h3 className='text-[#11142D] flex items-center'><BsDot size={35} color={'#3d0505'}/>Closed Roads</h3>
